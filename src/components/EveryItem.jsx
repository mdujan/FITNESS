...
const EveryItem = ({item}) => {
    const {service_image, providers_image, service_description, service_price, providers_name, service_name, _id}=item;
    return (
...
<p className="text-xl font-semibold text-yellow-700 p-3"><span className="text-lg text-gray-950 font-bold">Name :</span>  {providers_name}</p>
<img src={providers_image} alt="" className="object-cover object-center lg:w-20 h-20 w-7 rounded-full shadow-sm dark:bg-gray-500 dark:border-gray-300" />
